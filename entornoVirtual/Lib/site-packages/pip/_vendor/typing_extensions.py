...
# Some unconstrained type variable.  These are used by the container types.
    ...
    if '__orig_bases__' in cls.__dict__:
        ...
        if gvars is None:
            ...
            if not tvarset <= gvarset:
                ...
                raise TypeError(f"Some type variable ({s_vars}) are"
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            def __class_getitem__(cls, params):
                ...
                if cls is Protocol:
                    # Generic can only be subscripted with unique type variable.
                    if not all(isinstance(p, typing.TypeVar) for p in params):
                        i = 0
                        while isinstance(params[i], typing.TypeVar):
                            i += 1
                        raise TypeError(
                            "Parameters to Protocol[...] must all be type variable."
...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        Parameter specification variable exist primarily for the benefit of static
        ...
        Parameter specification variable defined with covariant=True or
        contravariant=True can be used to declare covariant or contravariant
        generic types.  These keyword arguments are valid, but their actual semantics
        are yet to be decided.  See PEP 612 for details.

        Parameter specification variable can be introspected. e.g.:
        ...
        Note that only parameter specification variable defined in global scope can
        be pickled.
        """
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        ``TypeGuard`` also works with type variable.  For more information, see
...
if hasattr(typing, "TypeVarTuple"):  # 3.11+
    ...
    class TypeVarTuple(_DefaultMixin):
        ...
        where ``T1`` and ``T2`` are type variable. To use these type variable
