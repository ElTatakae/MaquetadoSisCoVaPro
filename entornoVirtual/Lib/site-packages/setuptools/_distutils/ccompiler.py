...
class CCompiler:
    ...
    def link(
        ...
        on Unix and "foo.libs" on DOS/Windows).  However, they can include a
    ...
    def library_option(self, lib):
        """Return the compiler option to add 'libs' to the list of libraries
...
"""
    ...
    def find_library_file(self, dirs, lib, debug=0):
        ...
        library file 'libs' and return the full path to that file.  If
        'debug' true, look for a debugging version (if that makes sense on
        the current platform).  Return None if 'libs' wasn't found in any of
    ...
    #     "libs%s.%s" % (lib_name, ".a") for Unix static libraries
    ...
    #     extension for static library files, eg. '.a' or '.libs'
