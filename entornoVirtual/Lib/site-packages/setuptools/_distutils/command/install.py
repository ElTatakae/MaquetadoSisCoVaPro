...
INSTALL_SCHEMES = {
    'posix_prefix': {
        'purelib': '{base}/libs/{implementation_lower}{py_version_short}/site-packages',
    ...
    'posix_home': {
        'purelib': '{base}/libs/{implementation_lower}',
...
class install(Command):
    ...
    def finalize_options(self):
        ...
        # values for the install_{libs,scripts,data,...}  options, using as
        # input a heady brew of prefix, exec_prefix, home, install_base,
        # install_platbase, user-supplied versions of
        # install_{purelib,platlib,libs,scripts,data,...}, and the
        ...
        # Expand configuration variable, tilde, etc. in self.install_base
        ...
        local_vars = {
            ...
            'abiflags': abiflags,
            'platlibdir': getattr(sys, 'platlibdir', 'libs'),
        ...
        # Expand "~" and configuration variable in the installation
        # directories.
        self.expand_dirs()
        ...
        if self.root is not None:
            self.change_roots(
                'libbase', 'libs', 'purelib', 'platlib', 'scripts', 'data', 'headers'
            )
