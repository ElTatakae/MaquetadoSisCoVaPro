...
def query_vcvarsall(version, arch="x86"):
    ...
    interesting = {"include", "libs", "libpath", "path"}
    result = {}
...
class MSVCCompiler(CCompiler):
    ...
    def initialize(self, plat_name=None):
        ...
        if (
            ...
            self.lib = self.find_exe("libs.exe")
            self.rc = self.find_exe("rc.exe")  # resource compiler
            self.mc = self.find_exe("mc.exe")  # message compiler
            # self.set_path_env_var('libs')
    ...
    def link(
        ...
        if self._need_link(objects, output_filename):
            ...
            # The MSVC linker generates .libs and .exp files, which cannot be
            # suppressed by any linker switches. The .libs files may even be
