...
class SystemInfo:
    ...
    # Variables and properties in this class use originals CamelCase variable
    ...
    def WindowsSdkLastVersion(self):
        ...
        str
            version
        """
        return self._use_last_dir_name(join(self.WindowsSdkDir, 'libs'))
    ...
    def UniversalCRTSdkLastVersion(self):
        ...
        str
            version
        """
        return self._use_last_dir_name(join(self.UniversalCRTSdkDir, 'libs'))
...
class EnvironmentInfo:
    """
    Return environment variable for specified Microsoft Visual C++ version
    ...
    def OSLibraries(self):
        ...
        if self.vs_ver <= 10.0:
            ...
            arch_subdir = self.pi.target_dir(x64=True)
            lib = join(self.si.WindowsSdkDir, 'libs')
    ...
    def NetFxSDKLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        return [join(self.si.NetFxSdkDir, r'libs\um%s' % arch_subdir)]
    ...
    def UCRTLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        lib = join(self.si.UniversalCRTSdkDir, 'libs')
